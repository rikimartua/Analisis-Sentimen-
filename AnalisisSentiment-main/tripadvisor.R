...
restaurantUrl <- "/Restaurants-g294229-Jakarta_Java.html"
...
setwd("D:\IF\SEMESTER 5\DATA SINCES\PRAKTIKUM\Proyek\AnalisisSentiment-main\data")
# simpan data
saveRDS(dfrestaurant, "jakarta.rds")
write.csv(dfrestaurant,"jakarta.csv", row.names = FALSE)
dok<-read.csv("jakarta.csv" , stringsAsFactors = TRUE)
...
# Cara ngambil semua review dari Resturant pertama (diterapkan di shinynya)
dfrestaurant$name[1]
